    ...
    return (
        <div className="w-full h-full flex justify-center flex-wrap lg:pb-0 pt-16 relative">
            <div className="full absolute top-0 left-0 w-full h-[100px] flex justify-center items-center">
                ...
                <button className="ml-4 px-4 py-3 bg-accent text-white rounded-lg hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-dark cursor-pointer"
                    onClick={handleSearch}
                >Search</button>
                <button className="ml-4 px-4 py-3 bg-secondary text-white rounded-lg hover:bg-secondary-dark focus:outline-none focus:ring-2 focus:ring-secondary-dark cursor-pointer"
                    onClick={()=> setIsProdutsAreLoaded(false)}
                >All Products</button>
            </div>
            {
                products.map(
