    ...
    <div className="w-full h-screen flex justify-center items-center bg-[url('/bg-image.jpg')] bg-center bg-cover">
        ...
        <div className="w-[90%] lg:w-1/2 h-full flex justify-center items-center">
            <div className="w-[400px] h-[500px] backdrop-blur-xl shadow-2xl rounded-2xl flex flex-col items-center justify-center">
                ...
                <button onClick={googleLogin} className="w-3/4 p-3 mt-4 bg-white text-accent rounded-lg focus:outline-none focus:ring-2 hover:zoom-110 transition duration-300 flex justify-center items-center gap-2">
